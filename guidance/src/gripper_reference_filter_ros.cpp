...
namespace vortex::guidance {
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
GripperReferenceFilterNode::ReferenceFilterNode(const rclcpp::NodeOptions& options)
...
void GripperReferenceFilterNode::set_subscribers_and_publisher() {
    ...
    pose_sub_ = this->create_subscription<
        ...
        std::bind(&GripperReferenceFilterNode::pose_callback, this,
                  std::placeholders::_1));
    twist_sub_ = this->create_subscription<
        geometry_msgs::msg::TwistWithCovarianceStamped>(
        twist_topic, qos_sensor_data,
        std::bind(&GripperReferenceFilterNode::twist_callback, this,
                  std::placeholders::_1));
}
...
void GripperReferenceFilterNode::reference_callback(
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
void GripperReferenceFilterNode::pose_callback(
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
void GripperReferenceFilterNode::twist_callback(
...
void GripperReferenceFilterNode::handle_accepted(
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
Eigen::Vector18d GripperReferenceFilterNode::fill_reference_state() {
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
Eigen::Vector6d GripperReferenceFilterNode::fill_reference_goal(
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
vortex_msgs::msg::ReferenceFilter GripperReferenceFilterNode::fill_reference_msg() {
    ...
    //TODO: Discuss necessary goal with this with Cyprian and Jorgen
Eigen::Vector6d GripperReferenceFilterNode::apply_mode_logic(
...
void GripperReferenceFilterNode::execute(
    const std::shared_ptr<rclcpp_action::ServerGoalHandle<
        vortex_msgs::action::ReferenceFilterWaypoint>> goal_handle) { //TODO: Outdated vortex_msgs, change to the GripperReferenceFilterWaypoint when its made
    {
        std::lock_guard<std::mutex> lock(mutex_);
    ...
    //TODO: change all this given the new waypoint server for the GripperReferenceFilterNode 
    const geometry_msgs::msg::Pose goal =
...
RCLCPP_COMPONENTS_REGISTER_NODE(GripperReferenceFilterNode)
