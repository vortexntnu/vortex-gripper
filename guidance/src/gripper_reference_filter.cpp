...
void GripperReferenceFilter::calculate_Ad(const Eigen::Vector6d& omega,
                                   const Eigen::Vector6d& zeta) {
    //TODO: Clean up and clarify dimensions to define as per Fossen 336 (12.6)
    ...
    //TODO: Same thing applies here as per last TODO 
void GripperReferenceFilter::calculate_Bd(const Eigen::Vector6d& omega) {
    Eigen::Matrix6d omega_diag = omega.asDiagonal();
